...
| `IssuerNode`        | Number    | UInt64            | No        | A hint indicating which page of the issuer's directory links to this entry, in case the directory consists of multiple pages. {% amendment-disclaimer name="TokenEscrow" /%} |
